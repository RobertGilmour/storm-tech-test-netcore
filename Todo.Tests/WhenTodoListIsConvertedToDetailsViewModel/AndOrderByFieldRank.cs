...
{
    public class AndOrderByFieldImportance
    {
        private readonly TodoListDetailViewmodel resultViewModel;

        public AndOrderByFieldImportance()
        {
            ...
            resultViewModel = TodoListDetailViewmodelFactory.Create(todoList, true, TodoListSortFields.Importance);
        }

        [Fact]
        public void TodoListOrderedByImportance()
        {
